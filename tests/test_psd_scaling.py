...
def test_psd_scales_linearly_with_area_and_solid_angle():
    ...
    q1 = QuantumFieldTheory(surface_gravity=kappa, emitting_area_m2=1e-6, solid_angle_sr=0.05, coupling_efficiency=0.1)
    q2 = QuantumFieldTheory(surface_gravity=kappa, emitting_area_m2=2e-6, solid_angle_sr=0.05, coupling_efficiency=0.1)
