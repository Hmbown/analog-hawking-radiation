...
def test_spatial_convergence():
    ...
    # Test parameters
    laser_params = {"intensity": 1e17, "wavelength": 800e-9, "duration": 30e-15}

    plasma_params = {"density": 1e17, "temperature": 10000}
    ...
    for nx in nx_values:
        ...
        sim_result = simulation.simulate_laser_plasma_interaction(
            x_range=(-20e-6, 20e-6), t_range=(0, 50e-15), n_x=nx, n_t=50
        )
...
def test_temporal_convergence():
    ...
    for nt in nt_values:
        simulation = LaserPlasmaDynamics(laser_params, plasma_params)
        sim_result = simulation.simulate_laser_plasma_interaction(
            x_range=(-20e-6, 20e-6), t_range=(0, 50e-15), n_x=100, n_t=nt
        )
...
def test_parameter_sensitivity():
    ...
    # Baseline parameters
    baseline_laser_params = {"intensity": 1e17, "wavelength": 800e-9, "duration": 30e-15}

    baseline_plasma_params = {"density": 1e17, "temperature": 10000}
    ...
    baseline_result = baseline_sim.simulate_laser_plasma_interaction(
        x_range=(-20e-6, 20e-6), t_range=(0, 50e-15), n_x=100, n_t=50
    )
