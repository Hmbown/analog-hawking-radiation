...
kappa = 1e12
result = calculate_hawking_spectrum(
    kappa, n_points=1000, emitting_area_m2=1e-6, solid_angle_sr=0.05, coupling_efficiency=0.1
)
...
P_sig = band_power_from_spectrum(
    result["frequencies"], result["power_spectrum"], result["peak_frequency"], 1e8
)
