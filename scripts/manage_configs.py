...
class ConfigManager:
    ...
    def create_sweep_configs(self):
        ...
        coarse_config = {
            "sweep_type": "coarse",
            "parameters": {
                "laser_intensity": {"min": 1e16, "max": 1e20, "log_scale": True, "points": 8},
                "plasma_density": {"min": 1e16, "max": 1e20, "log_scale": True, "points": 8},
                "magnetic_field": {"min": 0, "max": 100, "log_scale": False, "points": 5},
                "temperature_constant": {"min": 1e3, "max": 1e5, "log_scale": True, "points": 6},
            },
            "fixed_parameters": {
        ...
        fine_config = {
            "sweep_type": "fine",
            "parameters": {
                "laser_intensity": {"min": 1e17, "max": 1e19, "log_scale": True, "points": 12},
                "plasma_density": {"min": 1e17, "max": 1e19, "log_scale": True, "points": 12},
                "temperature_constant": {"min": 5e3, "max": 5e4, "log_scale": True, "points": 8},
            },
            "fixed_parameters": {
                "magnetic_field": None,
                "laser_wavelength": 800e-9,
        ...
        hybrid_config = {
            "sweep_type": "hybrid",
            "parameters": {
                "laser_intensity": {"min": 5e17, "max": 1e20, "log_scale": True, "points": 10},
                "plasma_density": {"min": 5e17, "max": 1e20, "log_scale": True, "points": 10},
                "mirror_D": {"min": 1e-6, "max": 100e-6, "log_scale": True, "points": 8},
                "mirror_eta": {"min": 0.1, "max": 10.0, "log_scale": False, "points": 6},
            },
            "fixed_parameters": {
        ...
        # Save configurations
        configs = {"coarse": coarse_config, "fine": fine_config, "hybrid": hybrid_config}
    ...
    def create_optimization_configs(self):
        ...
        standard_opt = {
            ...
            "model_type": "standard",
            "parameters": {
                "laser_intensity": {"type": "real", "bounds": [1e16, 1e20], "log_scale": True},
                "plasma_density": {"type": "real", "bounds": [1e16, 1e20], "log_scale": True},
                "magnetic_field": {"type": "real", "bounds": [0, 100], "log_scale": False},
                "temperature_constant": {"type": "real", "bounds": [1e3, 1e5], "log_scale": True},
                "laser_wavelength": {
                    "type": "real",
                    "bounds": [400e-9, 1200e-9],
                    "log_scale": False,
                },
                "grid_max": {"type": "real", "bounds": [10e-6, 100e-6], "log_scale": False},
            },
        ...
        hybrid_opt = {
            ...
            "model_type": "hybrid",
            "parameters": {
                "laser_intensity": {"type": "real", "bounds": [1e17, 1e20], "log_scale": True},
                "plasma_density": {"type": "real", "bounds": [1e17, 1e20], "log_scale": True},
                "temperature_constant": {"type": "real", "bounds": [1e3, 1e5], "log_scale": True},
                "mirror_D": {"type": "real", "bounds": [1e-6, 100e-6], "log_scale": True},
                "mirror_eta": {"type": "real", "bounds": [0.1, 10.0], "log_scale": False},
            },
            "optimization_settings": {
                "n_calls": 80,
                "n_initial_points": 15,
        ...
        # Save configurations
        configs = {"standard": standard_opt, "hybrid": hybrid_opt}
    ...
    def create_surrogate_configs(self):
        ...
        surrogate_configs = {
            "gaussian_process": {
                ...
                "training": {"test_size": 0.2, "random_state": 42, "n_restarts_optimizer": 10},
            },
            "random_forest": {
                "model_type": "rf",
                "model_params": {
                ...
                "training": {"test_size": 0.2, "random_state": 42, "cross_validation": 5},
            },
            "neural_network": {
                "model_type": "nn",
                "architecture": {
    ...
    def create_experimental_configs(self):
        ...
        experimental_configs = {
            "baseline": {
                ...
                "plasma": {"density": 5e17, "temperature": 1e4, "composition": "hydrogen"},
                "laser": {
                    "intensity": 5e17,
                    "wavelength": 800e-9,
            ...
            "enhanced": {
                ...
                "plasma": {"density": 1e19, "temperature": 5e4, "composition": "hydrogen"},
                "laser": {
                    "intensity": 1e19,
                    "wavelength": 800e-9,
                    "pulse_duration": 30e-15,
            ...
            "breakthrough": {
                ...
                "plasma": {"density": 1e20, "temperature": 1e5, "composition": "hydrogen"},
                "laser": {
                    "intensity": 1e20,
                    "wavelength": 400e-9,
...
def main():
    parser = argparse.ArgumentParser(
        description="Configuration management for Hawking radiation protocol"
    )
    ...
    parser.add_argument(
        "--create-optimizations", action="store_true", help="Create optimization configurations"
    )
    parser.add_argument(
        "--create-surrogates", action="store_true", help="Create surrogate configurations"
    )
    parser.add_argument(
        "--create-experiments", action="store_true", help="Create experimental configurations"
    )
