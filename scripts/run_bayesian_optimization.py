...
def merit_from_params(plasma_density_m3: float, laser_intensity_Wm2: float, T_peak_K: float,
    ...
    # 10% uncertainties
    param_uncertainties = {k: 0.1 * v for k, v in base_params.items() if isinstance(v, (int, float))}
...
def main() -> int:
    ...
    parser.add_argument('--steps', type=int, default=100, help='Number of MCMC steps (50-100 recommended)')
    parser.add_argument('--walkers', type=int, default=24, help='Number of MCMC walkers')
    parser.add_argument('--seed', type=int, default=42)
    parser.add_argument('--samples', type=int, default=200, help='Monte Carlo samples in merit evaluation')
